...
export const activityApi = {
  ...
  recordKeyboard: (keyCount: number) => 
    invoke('record_keyboard_event', { keyCount }),
  
  recordMouse: (distance: number, clickCount: number) => 
    invoke('record_mouse_event', { distance, clickCount }),
