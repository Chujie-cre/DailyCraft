...
- **桌宠**: 基于 Phaser 3 的桌面宠物，支持拖拽、攀爬、随机行为（[桌宠图片格式要求:](src/deskpet/deskpet.png.md)）
...
│   │   └── About.vue         # 关于页面
│   ├── deskpet/              # 桌宠模块
│   │   ├── scenes/           # Phaser 场景（核心行为）
│   │   ├── managers/         # 配置管理 & 输入管理
│   │   ├── config/           # 宠物皮肤配置
│   │   ├── types/            # 类型定义
│   │   ├── PetOverlay.vue    # Vue 包裹 Phaser
│   │   └── deskpet.png.md    # 精灵图格式文档
│   ├── components/           
│   │   ├── Toast.vue         # 消息提示
